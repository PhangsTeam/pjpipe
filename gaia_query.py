...
"""
Queries the GAIA archive for pointing sources in the vicinity of the target.
Uses name resolution from config file.
"""

script_dir = os.path.dirname(os.path.realpath(__file__))
radvals = 15 * u.arcmin  # FoV for Gaia query
